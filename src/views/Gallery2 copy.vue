  ...
  <div class="gallery">
    ...
    <div class="container">
      <ul class="carousel__thumbnails">
        <li
          v-for="(gallery, id) in galleries"
          :key="gallery.id"
          :class="{ current: active === id }"
          @click="current(gallery.id)"
        >
          <img
            :src="gallery.image"
            @click="isShow = !isShow"
            ...
            <div class="modal__inner" v-cloak>
              ...
              <div class="carousel__inner">
                <div
                  ...
                  :key="galleries[active].id"
                  v-show="active === galleries[active].id"
                >
                  <img
                    :src="galleries[active].image"
                    alt="セパタクローの画像"
                  />
                  <h4 class="lz">{{ galleries[active].imageTitle }}</h4>
                  <p class="lz">&copy;{{ galleries[active].credit }}</p>
